...
public class Controller {
    ...
    public Customer addCard(HttpServletRequest request) throws StripeException {
        ...
        int expMonth=Integer.parseInt(request.getHeader("exp_month"));
        int expYear=Integer.parseInt(request.getHeader("exp_year"));

        return this.stripeClient.addCard(customerId,number,expMonth,expYear);
    }
