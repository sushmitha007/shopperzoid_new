...
public class ProductController {
    ...
    public ResponseEntity<Product> addListProduct(@RequestBody List<Product> products) throws ProductAlreadyExistsException {
        for(Product product:products){
            Product product1 = productService.saveProduct(product);
            logger.info("ProductID",product1.getProductId());
    ...
    public ResponseEntity<?> getProductName(){
        return new ResponseEntity<>(productService.getAllProductsforAutoComplete(),HttpStatus.OK);
    }
