...
export class PaymentComponent implements OnInit {
  ...
  constructor(private productDetailService : ProductDetailsService,
    private orderService:OrderService,private service: PaymentService,
        ...
        this.service.charge(this.custStripeId,this.amount).subscribe(data =>{
          ...
          this.service.deleteCard(this.custStripeId,this.cardId).subscribe(data=>{
            ...
            if(this.paymentStatus=="succeeded"){
              ...
              setTimeout(() => {
                this.router.navigate(['buyer-dashboard',{recUrl:this.receipt_url,balTran:this.balance_transaction,eMail:this.email}]);
              }, 3000);
