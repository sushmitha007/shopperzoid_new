...
public class ProductController {
    ...
    /**
     * PostMapping Annotation for posting products onto specific handler methods.
     */
    @PostMapping("product")
    ...
    /**
     * GetMapping Annotation for getting products onto specific handler methods.
     */
    ...
    /**
     * DeleteMapping Annotation for delete products onto specific handler methods.
     */
    ...
    /**
     * PutMapping Annotation for updating particular product onto specific handler methods.
     */
    @PutMapping("product")
