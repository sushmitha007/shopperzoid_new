...
/**
    ...
    public void setUp() {
        ...
        Seller s1=new Seller("1","Seller1",3.5,10.0,7,10,0,80.0);
        list1.add(s1);
        Seller s2=new Seller("2","Seller2",4.0,10.0,7,10,0,80.0);
        list1.add(s2);
    ...
    public void givenGetMappingUrlWithIdShouldReturnProductWIthThatThatId() throws Exception {
        ...
        verify(productService, times(1)).getProductById(product.getProductId());
    }
    ...
    public void givenGetMappingUrlAndIdShouldThrowProductNotFoundException() throws Exception {
        ...
        verify(productService, times(0)).getProductById(product.getProductId());
    }
    ...
    public void givenDeleteMappingUrlAndProductIdShouldReturnDeletedProduct() throws Exception {
        when(productService.deleteProductById(anyString())).thenReturn(Optional.of(product));
    ...
    public void givenDeleteMappingUrlAndProductIdShouldThrowProductNotFoundException() throws Exception {
        when(productService.deleteProductById(anyString())).thenThrow(ProductNotFoundException.class);
        ...
        //verify here verifies that productService deleteProductById method is only called once
        verify(productService, times(0)).deleteProductById(product.getProductId());
    }
