...
public class KafkaBuyerConsumerConfig {
    ...
    public ConsumerFactory<String, OrderDto> orderDtoConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<String, OrderDto>(config, new StringDeserializer(), new JsonDeserializer<>(OrderDto.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderDto> kafkaListenerContainerFactory5() {
