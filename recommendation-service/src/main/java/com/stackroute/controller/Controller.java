...
public class Controller {
    ...
    @GetMapping("buyer/products/recommendation/{buyerEmail}/")
    public ResponseEntity getBuyerRecommendedProduct(@PathVariable String buyerEmail) {
        return new ResponseEntity<>(buyerService.getAllRecommendedProducts(buyerEmail), HttpStatus.OK);
    }
    ...
    @GetMapping("buyer/Buy/{buyerEmail}/{productName}")
    public ResponseEntity buyProduct(@PathVariable String buyerEmail,@PathVariable String productName){
        ResponseEntity responseEntity;
        buyerService.buyProduct(buyerEmail,productName);
        responseEntity = new ResponseEntity<String>("successfully created", HttpStatus.CREATED);
        return responseEntity;
    }

    @GetMapping("buyer/Cart/{buyerEmail}/{productName}")
    public ResponseEntity addProductToCart(@PathVariable String buyerEmail,@PathVariable String productName){
        ResponseEntity responseEntity;
        buyerService.ProductAddToCart(buyerEmail,productName);
        responseEntity = new ResponseEntity<String>("successfully created", HttpStatus.CREATED);
        return responseEntity;
    }

    @GetMapping("buyer/Cart/delete/{buyerEmail}/{productName}")
    public ResponseEntity deleteProductFromCart(@PathVariable String buyerEmail,@PathVariable String productName){
        ResponseEntity responseEntity;
        buyerService.ProductDeleteFromCart(buyerEmail,productName);
