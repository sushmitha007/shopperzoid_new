...
public class ProductService {
    ...
    public Products saveProduct(Products products){
        ...
        productRepository.postProductSameBrand2(savedProducts.getId());
        productRepository.postProductCategory(savedProducts.getId());
        productRepository.postProductSimilarRelation(savedProducts.getId());
        productRepository.postProductSimilarRelation2(savedProducts.getId());
    ...
    public void consumeProduct(@Payload ProductRecomDto productRecomDTO){
        ...
        newProducts.setProductImage(productRecomDTO.getProductImage());
